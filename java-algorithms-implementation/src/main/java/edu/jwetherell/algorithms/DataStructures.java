package edu.jwetherell.algorithms;
...
import edu.jwetherell.algorithms.data_structures.AVLTree;
import edu.jwetherell.algorithms.data_structures.BTree;
import edu.jwetherell.algorithms.data_structures.BinarySearchTree;
import edu.jwetherell.algorithms.data_structures.BinaryHeap;
import edu.jwetherell.algorithms.data_structures.CompactSuffixTrie;
import edu.jwetherell.algorithms.data_structures.Graph;
import edu.jwetherell.algorithms.data_structures.HashMap;
import edu.jwetherell.algorithms.data_structures.IHeap;
import edu.jwetherell.algorithms.data_structures.IList;
import edu.jwetherell.algorithms.data_structures.IMap;
import edu.jwetherell.algorithms.data_structures.IQueue;
import edu.jwetherell.algorithms.data_structures.IStack;
import edu.jwetherell.algorithms.data_structures.ITree;
import edu.jwetherell.algorithms.data_structures.IntervalTree;
import edu.jwetherell.algorithms.data_structures.KdTree;
import edu.jwetherell.algorithms.data_structures.PatriciaTrie;
import edu.jwetherell.algorithms.data_structures.QuadTree;
import edu.jwetherell.algorithms.data_structures.RadixTrie;
import edu.jwetherell.algorithms.data_structures.RedBlackTree;
import edu.jwetherell.algorithms.data_structures.SegmentTree;
import edu.jwetherell.algorithms.data_structures.SuffixTree;
import edu.jwetherell.algorithms.data_structures.TreeMap;
import edu.jwetherell.algorithms.data_structures.TrieMap;
import edu.jwetherell.algorithms.data_structures.List;
import edu.jwetherell.algorithms.data_structures.Matrix;
import edu.jwetherell.algorithms.data_structures.Queue;
import edu.jwetherell.algorithms.data_structures.SkipList;
import edu.jwetherell.algorithms.data_structures.SplayTree;
import edu.jwetherell.algorithms.data_structures.Stack;
import edu.jwetherell.algorithms.data_structures.SuffixTrie;
import edu.jwetherell.algorithms.data_structures.Treap;
import edu.jwetherell.algorithms.data_structures.Trie;
import edu.jwetherell.algorithms.graph.BellmanFord;
import edu.jwetherell.algorithms.graph.CycleDetection;
import edu.jwetherell.algorithms.graph.Dijkstra;
import edu.jwetherell.algorithms.graph.FloydWarshall;
import edu.jwetherell.algorithms.graph.Johnson;
import edu.jwetherell.algorithms.graph.Prim;
import edu.jwetherell.algorithms.graph.TopologicalSort;
...
*/
    ...
    private static boolean testGraph() {
        {   // UNDIRECTED GRAPH
            ...
            java.util.List<Graph.Vertex<Integer>> verticies = new ArrayList<Graph.Vertex<Integer>>();
            ...
            java.util.List<Graph.Edge<Integer>> edges = new ArrayList<Graph.Edge<Integer>>();
            ...
            java.util.List<Graph.Vertex<Integer>> cyclicVerticies = new ArrayList<Graph.Vertex<Integer>>();
            ...
            java.util.List<Graph.Edge<Integer>> cyclicEdges = new ArrayList<Graph.Edge<Integer>>();
        ...
        {   // DIRECTED GRAPH (WITH NEGATIVE WEIGHTS)
            ...
            Map<Graph.Vertex<Integer>, Map<Graph.Vertex<Integer>, Set<Graph.Edge<Integer>>>> paths = Johnson.getAllPairsShortestPaths(directed);
            if (debug > 1) {
            ...
            Map<Graph.Vertex<Integer>, Map<Graph.Vertex<Integer>, Integer>> pathWeights = FloydWarshall.getAllPairsShortestPaths(directed);
        ...
        {   // UNDIRECTED GRAPH
            ...
            java.util.List<Graph.Vertex<Integer>> cycledVerticies = new ArrayList<Graph.Vertex<Integer>>();
            Graph.Vertex<Integer> cv1 = new Graph.Vertex<Integer>(1);
            ...
            java.util.List<Graph.Edge<Integer>> cycledEdges = new ArrayList<Graph.Edge<Integer>>();
    ...
    private static final String getWeightMapString(Map<Graph.Vertex<Integer>, Map<Graph.Vertex<Integer>, Integer>> paths) {
        StringBuilder builder = new StringBuilder();
        for (Graph.Vertex<Integer> v : paths.keySet()) {
            Map<Graph.Vertex<Integer>, Integer> map = paths.get(v);
            for (Graph.Vertex<Integer> v2 : map.keySet()) {
                builder.append("From=").append(v.getValue()).append(" to=").append(v2.getValue()).append("\n");
